<template>
  <div class="imageMarket-app-container">
    ...
    <el-form>
      <el-form-item label="构造多云协作框架API进度">
    ...
    <el-form label-position="top">
      <el-form-item label="步骤 1：接收示例代码输入">
          <json-editor
            style="width:100%"
            :value="jsonString"
      ...
      <el-form-item label="步骤 2.1：提取关键云服务操作">
        <el-button type="text" @click="drawLine()">点击分析</el-button>
        <span id="analysisTitle" style="color:brown;font-size:18px;margin-left:20px">待分析</span>
      </el-form-item>

      <el-form-item label="步骤 2.2：构造云服务树形调用链">
        <el-button type="text" @click="constructTree()">点击构造</el-button>
        <span id="analysisTree" style="color:brown;font-size:18px;margin-left:20px">待生成</span>
        <div id="myChart" style="width: 100%; height: 500px;float: left;" />
      </el-form-item>

      <el-form-item label="步骤 3：生成初始的、针对特定云服务代码片段的API调用接口(三元组)">
        <el-button type="text" @click="showTriple()">点击生成</el-button>
