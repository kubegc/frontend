        ...
        >
            <el-card v-if="card.type == 'span1'" class="box-card">
                ...
                <div class="text item">
                  ...
                  <el-row gutter="10">
                      <el-col span="5" style="width:50%">
                        <el-button v-if="card.color == 'black'" style="background-color:black;width:7em;height:3em;font-size:1em;color:white;margin-left:20%">配置参数</el-button>
                        <el-button v-if="card.color == 'red'" style="background-color:red;width:7em;height:3em;font-size:1em;color:white;margin-left:20%">配置参数</el-button>
                        <el-button v-if="card.color == 'brown'" style="background-color:brown;width:7em;height:3em;font-size:1em;color:white;margin-left:20%">配置参数</el-button>
                        <el-button v-if="card.color == 'green'" style="background-color:green;width:7em;height:3em;font-size:1em;color:white;margin-left:20%">配置参数</el-button>
                      </el-col>
                      <el-col span="5" style="width:50%">
                        <el-button v-if="card.color == 'black'" style="background-color:black;width:7em;height:3em;font-size:1em;color:white;margin-left:20%">启动</el-button>
                        <el-button v-if="card.color == 'red'" style="background-color:red;width:7em;height:3em;font-size:1em;color:white;margin-left:20%">终止</el-button>
                      <el-button v-if="card.color == 'brown'" style="background-color:brown;width:7em;height:3em;font-size:1em;color:white;margin-left:20%">
                          <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                          运行
                      </el-button>
                      <el-button v-if="card.color == 'green'" style="background-color:green;width:7em;height:3em;font-size:1em;color:white;margin-left:20%">成功
                      </el-button>
                      </el-col>
                  </el-row>
                </div>
